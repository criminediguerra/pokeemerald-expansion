...
const struct Tileset gTileset_Memorial_Pillar =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Memorial_Pillar,
    .palettes = gTilesetPalettes_Memorial_Pillar,
    .metatiles = gMetatiles_Memorial_Pillar,
...
const struct Tileset gTileset_Silver_Rock_Island =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Silver_Rock_Island,
    .palettes = gTilesetPalettes_Silver_Rock_Island,
    .metatiles = gMetatiles_Silver_Rock_Island,
