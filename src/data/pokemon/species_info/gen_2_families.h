...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_DUDUNSPARCE_TWO_SEGMENT, CONDITIONS({IF_KNOWS_MOVE, MOVE_HYPER_DRILL}, {IF_PID_MODULO_100_GT, 0})},
                                ...
                                {EVO_ITEM, ITEM_BERSERK_GENE, SPECIES_DUDUNSPARCE_THREE_SEGMENT}),
    },
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "managed to scale MT. SILVER thanks\n"
    ...
    [SPECIES_WOLFMAN] =
    {
        ...
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 6 : 12,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(1, 20),
            ANIMCMD_FRAME(0, 10),
        ),
    ...
    [SPECIES_WEHRWOLF] =
    {
        ...
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 0 : 8,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 25),
            ANIMCMD_FRAME(0, 30),
    ...
    [SPECIES_WARTHUG] =
    {
        ...
        .backPicSize = P_GBA_STYLE_SPECIES_GFX ? MON_COORDS_SIZE(48, 40) : MON_COORDS_SIZE(56, 40),
        .backPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 6 : 12,
        .backAnimId = BACK_ANIM_JOLT_RIGHT,
    ...
    [SPECIES_WARTUSK] =
    {
        ...
        .frontPicYOffset = P_GBA_STYLE_SPECIES_GFX ? 0 : 9,
        .frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 10),
            ANIMCMD_FRAME(1, 25),
            ANIMCMD_FRAME(0, 10),
