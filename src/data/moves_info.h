...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_THUNDERBOLT] =
    {
        .name = COMPOUND_STRING("THUNDERBOLTS"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GLAIVE_RUSH] =
    {
        .name = COMPOUND_STRING("GLAVIE RUSH"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_TRIPLE_DIVE] =
    {
        .name = COMPOUND_STRING("TRIPLE DRIVE"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("BLACK HOLE ECLYPSE"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STOKED_SPARKSURFER] =
    {
        ...
        .description = COMPOUND_STRING(
            "RAICHU attacks with full\n"
            "force. Causes paralysis."),
        .effect = EFFECT_HIT,
        .power = 175,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
