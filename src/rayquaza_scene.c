...
static void LoadDuoFightSceneGfx(void)
{
    ...
    while (FreeTempTileDataBuffersIfPossible())
        ;
    DecompressDataWithHeaderVram(gRaySceneDuoFight_Clouds2_Tilemap, sRayScene->tilemapBuffers[0]);
    DecompressDataWithHeaderVram(gRaySceneDuoFight_Clouds1_Tilemap, sRayScene->tilemapBuffers[1]);
    DecompressDataWithHeaderVram(gRaySceneDuoFight_Clouds3_Tilemap, sRayScene->tilemapBuffers[2]);
...
static void LoadTakesFlightSceneGfx(void)
{
    ...
    while (FreeTempTileDataBuffersIfPossible())
        ;
    DecompressDataWithHeaderVram(gRaySceneDuoFight_Clouds2_Tilemap, sRayScene->tilemapBuffers[0]);
    DecompressDataWithHeaderVram(gRaySceneTakesFlight_Bg_Tilemap, sRayScene->tilemapBuffers[1]);
    DecompressDataWithHeaderVram(gRaySceneTakesFlight_Rayquaza_Tilemap, sRayScene->tilemapBuffers[2]);
...
static void LoadDescendsSceneGfx(void)
{
    ...
    while (FreeTempTileDataBuffersIfPossible())
        ;
    DecompressDataWithHeaderVram(gRaySceneDescends_Light_Tilemap, sRayScene->tilemapBuffers[0]);
    DecompressDataWithHeaderVram(gRaySceneDescends_Bg_Tilemap, sRayScene->tilemapBuffers[3]);
...
static void LoadChargesSceneGfx(void)
{
    ...
    while (FreeTempTileDataBuffersIfPossible())
        ;
    DecompressDataWithHeaderVram(gRaySceneCharges_Orbs_Tilemap, sRayScene->tilemapBuffers[0]);
    DecompressDataWithHeaderVram(gRaySceneCharges_Rayquaza_Tilemap, sRayScene->tilemapBuffers[1]);
    DecompressDataWithHeaderVram(gRaySceneCharges_Streaks_Tilemap, sRayScene->tilemapBuffers[2]);
    DecompressDataWithHeaderVram(gRaySceneCharges_Bg_Tilemap, sRayScene->tilemapBuffers[3]);
...
static void LoadChasesAwaySceneGfx(void)
{
    ...
    while (FreeTempTileDataBuffersIfPossible())
        ;
    DecompressDataWithHeaderVram(gRaySceneChasesAway_Bg_Tilemap, sRayScene->tilemapBuffers[1]);
    DecompressDataWithHeaderVram(gRaySceneChasesAway_Light_Tilemap, sRayScene->tilemapBuffers[0]);
    DecompressDataWithHeaderVram(gRaySceneChasesAway_Ring_Tilemap, sRayScene->tilemapBuffers[2]);
