...
static void LoadSlotMachineGfx(void)
{
    ...
    DecompressDataWithHeaderVram(gSlotMachineDigitalDisplay_Gfx, sDigitalDisplayGfxPtr);
    sReelTimeGfxPtr = Alloc(0x3600);
    DecompressDataWithHeaderVram(sReelTimeGfx, sReelTimeGfxPtr);
...
static void LoadMenuGfx(void)
{
    ...
    DecompressDataWithHeaderVram(gSlotMachineMenu_Gfx, sMenuGfx);
