...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_BLUEFIN] = {MAP_GROUP(JOHTO_SAFARI), MAP_NUM(JOHTO_SAFARI), HEAL_LOCATION_JOHTO_SAFARI},
    [MAPSEC_KASADO] = {MAP_GROUP(KASADO_CITY), MAP_NUM(KASADO_CITY), HEAL_LOCATION_KASADO_CITY},
    [MAPSEC_WHITESTONE] = {MAP_GROUP(WHITESTONE_CITY), MAP_NUM(WHITESTONE_CITY), HEAL_LOCATION_WHITESTONE_CITY},
    [MAPSEC_KUGA] = {MAP_GROUP(KUGA_TOWN), MAP_NUM(KUGA_TOWN), HEAL_LOCATION_KUGA_TOWN},
    [MAPSEC_ROUTE_3] = {MAP_GROUP(ROUTE3), MAP_NUM(ROUTE3), HEAL_LOCATION_ROUTE3},
    [MAPSEC_ROUTE_32] = {MAP_GROUP(ROUTE32), MAP_NUM(ROUTE32), HEAL_LOCATION_ROUTE32},
