...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_SILPH] = { _("SILPH CO.") },
    [TRAINER_CLASS_SILPH_CHIEF] = { _("SILPH CHIEF"), 20 },
    [TRAINER_CLASS_ROCKET_ADMIN] = { _("EXECUTIVE"), 10 },
    [TRAINER_CLASS_ROCKET_BOSS] = { _("ROCKET BOSS"), 25 },
    ...
    [TRAINER_CLASS_BUSINESSMAN] = { _("BUSINESSMAN"), 10 },
