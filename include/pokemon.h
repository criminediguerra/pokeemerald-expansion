...
struct PokemonSubstruct0
{
    ...
    u16 dynamaxLevel:4;     // [26-29]
    u16 gigantamaxFactor:1; // [30]
    u16 unused_1F:1;        // [31]
...
struct PokemonSubstruct3
{
    ...
    u32 isShadow:1;                 // [63]
    u32 metGame:4;                  // [64-67]
    u32 coolRibbon:3;               // [68-70] Stores the highest contest rank achieved in the Cool category.
    u32 beautyRibbon:3;             // [71-73] Stores the highest contest rank achieved in the Beauty category.
    u32 cuteRibbon:3;               // [74-76] Stores the highest contest rank achieved in the Cute category.
    u32 smartRibbon:3;              // [77-79] Stores the highest contest rank achieved in the Smart category.
    u32 toughRibbon:3;              // [80-82] Stores the highest contest rank achieved in the Tough category.
    u32 championRibbon:1;           // [83] Given when defeating the Champion. Because both RSE and FRLG use it, later generations don't specify from which region it comes from.
    u32 winningRibbon:1;            // [84] Given at the Battle Tower's Level 50 challenge by winning a set of seven battles that extends the current streak to 56 or more.
    u32 victoryRibbon:1;            // [85] Given at the Battle Tower's Level 100 challenge by winning a set of seven battles that extends the current streak to 56 or more.
    u32 artistRibbon:1;             // [86] Given at the Contest Hall by winning a Master Rank contest with at least 800 points, and agreeing to have the Pokémon's portrait placed in the museum after being offered.
    u32 effortRibbon:1;             // [87] Given at Slateport's market to Pokémon with maximum EVs.
    u32 marineRibbon:1;             // [88] Never distributed.
    u32 landRibbon:1;               // [89] Never distributed.
    u32 skyRibbon:1;                // [90] Never distributed.
    u32 countryRibbon:1;            // [91] Distributed during Pokémon Festa '04 and '05 to tournament winners.
    u32 nationalRibbon:1;           // [92] Given to purified Shadow Pokémon in Colosseum/XD.
    u32 earthRibbon:1;              // [93] Given to teams that have beaten Mt. Battle's 100-battle challenge in Colosseum/XD.
    u32 worldRibbon:1;              // [94] Distributed during Pokémon Festa '04 and '05 to tournament winners.
